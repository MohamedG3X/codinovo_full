  ...
  async function saveTiers(){
    ...
    try {
      const payload = {
        ...
        // thresholds optional to expose here; keep them as-is if not shown
      }
      await api.patch('/admin/tiers', payload, { headers })
      // Update visible per-user price according to their level
                    ...
                    <select
                      ...
                      onChange={async (e) => {
                        ...
                        try {
                          ...
                          // fetch fresh price after level change
